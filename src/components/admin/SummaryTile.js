    ...
    <div className="bg-slate-50 rounded-2xl border border-slate-200 p-4 sm:p-5 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          className="text-xs border border-slate-300 rounded-lg px-2 py-1 bg-white text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
        >
...
function KpiCard({ icon, title, value, gradient, onClick }) {
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow p-1.5 mb-1">
        {icon}
      </div>
